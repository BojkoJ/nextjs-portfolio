// Auto-generated from the official Go gopher vector (golang-samples/gopher-vector,
// by Takuya Ueda; original artwork CC BY 3.0, gopher mascot by Renée French).
// This is the gopher with its two pupil groups removed -- GopherEyes renders the
// pupils separately so they can follow the cursor. Do not edit by hand.

export const GOPHER_HEAD_SVG = `
